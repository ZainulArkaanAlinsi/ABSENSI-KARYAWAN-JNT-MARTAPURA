                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {['Rider Martapura', 'Inbound', 'Outbound', 'Office'].map((dept) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-4 h-4 rounded-full border-2 transition-all ${active ? 'bg-(--accent-primary) border-(--accent-primary)' : 'border-(--border-color)'}`}
                            >
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-4 min-w-0">
                                <div
                                  className={`w-4 h-4 rounded-md border-2 transition-all flex items-center justify-center ${active ? 'bg-(--accent-primary) border-(--accent-primary)' : 'border-(--border-color)'}`}
                                >
                              ...
                              {active && (
                                <div className="text-[10px] font-black text-(--accent-primary)">
                                  TERPILIH
                                </div>
                              )}
                            </button>
                  ...
                  {(form.departments.length > 0 || form.attendees.length > 0) && (
                    ...
                    >
                      ...
                      <p className="text-[11px] font-bold italic leading-relaxed text-(--text-primary) opacity-80 uppercase">
                        <span className="text-(--accent-primary) font-black uppercase not-italic">
                          Push Notifikasi Otomatis:
                        </span>
                        <br />
                        Akan dikirim ke {form.departments.length} unit dan {form.attendees.length}{' '}
                        kurir terpilih pada <span className="text-(--accent-primary)">-24 jam</span>{' '}
                        & <span className="text-(--accent-primary)">-30 menit</span> sebelum agenda.
                      </p>
                    </motion.div>
                  )}
                </motion.div>
