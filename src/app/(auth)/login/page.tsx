...
import {
  ...
  Package, MapPin, Users, TrendingUp,
} from "lucide-react";
...
// ── animated stat pill ───────────────────────────────────────────────────────
function StatPill({ icon: Icon, label, value, delay }: {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-white/40 text-[9px] font-bold uppercase tracking-widest leading-none mb-0.5">{label}</p>
...
// ── magnetic button ───────────────────────────────────────────────────────────
function MagneticButton({ loading, disabled, onClick }: {
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 lg:p-8 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full opacity-10 blur-[60px]"
          ...
          <div className="relative z-10 h-full flex flex-col p-8 lg:p-10">
            ...
            >
              ...
              <p className="text-white/45 text-sm font-medium leading-relaxed">
                Kelola absensi, karyawan, dan operasional harian JNE Martapura dari satu dashboard terpusat.
              </p>
            </motion.div>
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-40 h-40 opacity-[0.04] rounded-full -translate-y-1/2 translate-x-1/2"
            style={{ background: "radial-gradient(circle, #F97316, transparent)" }} />
            ...
            {isSuccess && (
              ...
              >
                ...
                >
                  ...
                  >
                    <Image src="/logo-jne.svg" alt="JNE" width={44} height={44} className="brightness-0 invert" />
                  </motion.div>
