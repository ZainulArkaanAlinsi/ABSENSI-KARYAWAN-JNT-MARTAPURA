          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                style={{ background: 'rgba(227,30,36,0.25)' }} // #E31E24 with opacity
              />
              ...
              <motion.div
                ...
                style={{ border: '2px solid rgba(227,30,36,0.15)', borderTopColor: '#E31E24' }}
              />

              {/* Center Logo */}
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <Shield size={28} style={{ color: '#E31E24' }} className="animate-pulse" />
              </div>
            </div>
