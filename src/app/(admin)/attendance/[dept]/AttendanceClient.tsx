      ...
      <div className="dash-root px-1 sm:px-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: 'Authorized Leave', value: totalLeave,   color: 'var(--att-leave)',   icon: Activity },
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/3">
                {loading ? (
                  ...
                  <tr><td colSpan={6} className="px-6 py-20 text-center"><p className="text-[11px] font-black text-slate-600 uppercase tracking-[0.2em]">Zero signals detected today</p></td></tr>
                ) : (
                  <AnimatePresence>
                    {records.map((rec, idx) => {
                      let lateDisplay = '—';
