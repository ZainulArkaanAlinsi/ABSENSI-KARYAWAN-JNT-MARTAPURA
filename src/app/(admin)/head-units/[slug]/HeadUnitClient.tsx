      ...
      {empLoading ? (
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] font-bold text-[#E31E24] uppercase tracking-widest">
                  Belum Absen
                </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-xl bg-slate-50 p-4 border border-slate-100">
                  ...
                  <p className="text-[11px] text-slate-500 leading-relaxed">
                    {rule.gpsRequired
                      ? `Radius ${rule.radiusMeters}m dari koordinat.`
                      : 'Bebas lokasi.'}
                  </p>
                </div>
                <div className="rounded-xl bg-slate-50 p-4 border border-slate-100">
                  ...
                  <p className="text-[11px] text-slate-500 leading-relaxed">
                    Toleransi: {rule.toleranceMinutes} menit.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
                ...
                <div className="flex items-end gap-2">
                  <p className="text-4xl font-black text-slate-900">
                    {unitEmployees.filter((e) => e.faceRegistered).length}
                  </p>
                      ...
                      <tr key={emp.id} className="hover:bg-slate-50/50">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="h-9 w-9 rounded-xl border border-slate-100 bg-slate-50 flex items-center justify-center text-[11px] font-black text-slate-900">
                              {emp.name.charAt(0)}
                            </div>
                            <div>
                        ...
                        <td className="px-6 py-4">
                          {record?.checkIn?.time ? (
                            <span className="text-[11px] font-black text-emerald-600 font-mono">
                              {safeFormatTime(record.checkIn.time, 'HH:mm:ss')}
                            </span>
                          ) : (
