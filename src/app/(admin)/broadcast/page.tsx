        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="px-3 py-1 rounded-full bg-orange-600/10 border border-orange-600/20 text-orange-600 text-[9px] font-black uppercase tracking-widest animate-pulse">
                Broadcast Engine
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
              ...
              <form onSubmit={handleSend} className="space-y-10 relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                      <div
                        className={`p-4 rounded-xl ${target === 'all' ? 'bg-orange-600 text-white' : 'bg-white/5'}`}
                      >
                        <Users size={24} />
                      </div>
                    ...
                    >
                      <div
                        className={`p-4 rounded-xl ${target === 'specific' ? 'bg-orange-600 text-white' : 'bg-white/5'}`}
                      >
                        <User size={24} />
                      </div>
                      <div className="text-left">
                ...
                <InteractiveButton
                  disabled={
                    loading || !title || !message || (target === 'specific' && !selectedUser)
                  }
                ...
                <AnimatePresence>
                  {status === 'success' && (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest">
                        Pesan Berhasil Dipublikasikan ke Nexus App & Web!
                      </span>
                    </motion.div>
                  )}
                </AnimatePresence>
          ...
          <div className="xl:col-span-4 space-y-8">
            <GlassCard className="p-10 border-none bg-orange-600 text-white relative overflow-hidden group">
              ...
              <h3 className="text-lg font-black italic uppercase tracking-tighter mb-8 relative">
                Push Engine
              </h3>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-black italic leading-tight">
                      Notifikasi akan muncul di lockscreen HP kurir secara instan.
                    </p>
                  </div>
                </div>
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-black italic leading-tight">
                      Dashboard web akan memunculkan banner notifikasi real-time.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <GlassCard className="p-8 border-none bg-white/5 dark:bg-slate-900/40">
              ...
              <div className="space-y-4">
                ...
                {recentBroadcasts.length === 0 && (
                  <p className="text-center py-10 text-[10px] font-black uppercase tracking-widest text-slate-600 italic">
                    No history yet
                  </p>
                )}
              </div>
